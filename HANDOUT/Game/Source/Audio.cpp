...
bool Audio::PlaySpatialFx(unsigned int id, int repeat, Entity* entity1, Entity* entity2, uint minDistance, uint maxDistance) {

	bool ret = false;

	//TODO 01:Spatial audio
	//- Check for distance between player/entity and change volume accordingly
	
	//- Check if entity is on camera frame
